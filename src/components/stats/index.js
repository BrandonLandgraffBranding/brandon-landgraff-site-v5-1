    ...
    <section ref={ref} className={cn('bio-section vh-100')} data-scroll-section>
      <Container>
        <div>
          ...
          <div>
            <h4 className='section-title' data-scroll>WHAT IS MY EXPERIENCE?</h4>
            <h4 className='section-part' data-scroll>PART 04</h4>
          </div>
        </div>
        <div className='two-column section-height section-wrap'>
          <div className='stats-container'>
              <h2 id="stats-text" className={cn({'is-reveal': reveal})}>I've completed a wide range of projects using CSS, HTML, JavaScript, Liquid, Adobe Illustrator, Adobe XD to improve Shopify stores.</h2>
          </div>
